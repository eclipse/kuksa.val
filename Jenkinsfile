    ...
    stage('Build') {
        ...
        parallel arm64: {
                stage('arm64') {
                    ...
                    sh "docker buildx build --platform=linux/arm64 -f ./kuksa_client/Dockerfile -t arm64/kuksa-client:${versiontag} --output type=docker,dest=./artifacts/kuksa-client-${versiontag}-arm64.tar ."
                }
                }, 
                amd64: {
                stage('amd64') {
                    ...
                    sh "docker buildx build --platform=linux/amd64 -f ./kuksa_client/Dockerfile -t amd64/kuksa-client:${versiontag} --output type=docker,dest=./artifacts/kuksa-client-${versiontag}-amd64.tar ."
