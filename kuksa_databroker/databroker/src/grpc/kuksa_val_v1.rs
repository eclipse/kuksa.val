        ...
        for request in request.into_inner().updates {
            match self.get_id_by_path(&request.path).await {
                Some(id) => {
                    ...
                    let mut update = broker::EntryUpdate::new();
                    for field in fields {
                        match field {
...
fn value_from_proto_value(value: Option<proto::datapoint::Value>) -> broker::Value {
    match value {
        Some(value) => match value {
            proto::datapoint::Value::String(value) => types::Value::String(value),
            proto::datapoint::Value::Bool(value) => types::Value::Bool(value),
            proto::datapoint::Value::Int32(value) => types::Value::Int32(value),
            proto::datapoint::Value::Int64(value) => types::Value::Int64(value),
            proto::datapoint::Value::Uint32(value) => types::Value::Uint32(value),
            proto::datapoint::Value::Uint64(value) => types::Value::Uint64(value),
            proto::datapoint::Value::Float(value) => types::Value::Float(value),
            proto::datapoint::Value::Double(value) => types::Value::Double(value),
            proto::datapoint::Value::StringArray(array) => types::Value::StringArray(array.values),
            proto::datapoint::Value::BoolArray(array) => types::Value::BoolArray(array.values),
            proto::datapoint::Value::Int32Array(array) => types::Value::Int32Array(array.values),
            proto::datapoint::Value::Int64Array(array) => types::Value::Int64Array(array.values),
            proto::datapoint::Value::Uint32Array(array) => types::Value::Uint32Array(array.values),
            proto::datapoint::Value::Uint64Array(array) => types::Value::Uint64Array(array.values),
            proto::datapoint::Value::FloatArray(array) => types::Value::FloatArray(array.values),
            proto::datapoint::Value::DoubleArray(array) => types::Value::DoubleArray(array.values),
        },
        None => types::Value::NotAvailable,
    }
}
...
fn proto_datapoint_from_value(value: broker::Value) -> Option<proto::Datapoint> {
    match value {
        types::Value::NotAvailable => None,
        types::Value::Bool(value) => Some(proto::Datapoint {
            value: Some(proto::datapoint::Value::Bool(value)),
...
impl broker::EntryUpdate {
    fn set_value_from_proto_entry(&mut self, datapoint: &Option<proto::DataEntry>) {
        self.datapoint = match datapoint {
            Some(datapoint) => match &datapoint.value {
                Some(value) => Some(datapoint_from_proto_datapoint(value.clone())),
                None => None,
            },
            None => None,
        };
