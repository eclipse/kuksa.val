...
#
# Building all currently supported targets for kuksa-cli.
...
python3 createbom.py ../kuksa-cli
cd ..
...
# Buidling AMD46
echo "Building AMD64"
cross build --target x86_64-unknown-linux-musl --bin kuksa-cli --release
...
# Buidling ARM64
echo "Building ARM64"
cross build --target aarch64-unknown-linux-musl --bin kuksa-cli --release
echo "Cleaning up...."
rm -rf ../target/release
...
cross build --target riscv64gc-unknown-linux-gnu --bin kuksa-cli --release
echo "Cleaning up...."
rm -rf ../target/release
...
mkdir ../dist/amd64
cp ../target/x86_64-unknown-linux-musl/release/kuksa-cli ../dist/amd64
cp -r ./kuksa-cli/thirdparty ../dist/amd64

echo "Prepare arm64 dist folder"
mkdir ../dist/arm64
cp ../target/aarch64-unknown-linux-musl/release/kuksa-cli ../dist/arm64
cp -r ./kuksa-cli/thirdparty ../dist/arm64

echo "Prepare riscv64 dist folder"
mkdir ../dist/riscv64
cp ../target/riscv64gc-unknown-linux-gnu/release/kuksa-cli ../dist/riscv64
cp -r ./kuksa-cli/thirdparty ../dist/riscv64
